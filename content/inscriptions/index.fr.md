...
1. Vérifier avec les capitaines des équipes **avant** de démarrer
1. Rendez-vous sur
   **[notre page HelloAsso dédiée](https://www.helloasso.com/associations/volley-club-nogentais/adhesions/adhesion-fsgt-vcn-2026-2027/)**.
1. Suivez les étapes pour finaliser votre inscription en ligne.
1. Vous recevrez un **email de confirmation** avec toutes les informations pratiques.
